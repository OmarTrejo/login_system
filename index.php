                ...
                <div id="recoverform">
                    <div class="row m-t-20">
                        <form class="col-12" action="./core/register.php" method="POST">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control form-control-lg" placeholder="Nombre" aria-label="nombre" aria-describedby="basic-addon1" required="">
                            </div>
                            <div class="input-group mb-3">
                                <input type="text" class="form-control form-control-lg" placeholder="Télefono" aria-label="telefono" aria-describedby="basic-addon1" maxlength="10" required="">
                            </div>
                            <div class="input-group mb-3">
                            ...
                            <div class="input-group mb-3">
                                <input type="password" class="form-control form-control-lg" placeholder="Password" aria-label="password" aria-describedby="basic-addon1" required="" minlength="8" maxlength="10" >
                            </div>
